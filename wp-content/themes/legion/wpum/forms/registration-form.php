...
<div id="wpum-form-register-<?php echo esc_attr($atts['form_id']); ?>" class="wpum-registration-form-wrapper">
    ...
    <form action="#" method="post" id="wpum-register-<?php echo esc_attr($atts['form_id']); ?>"
          class="wpum-registration-form" name="wpum-register-<?php echo esc_attr($atts['form_id']); ?>"
        ...
        <?php foreach ($register_fields as $key => $field) : ?>
            <fieldset class="fieldset-<?php esc_attr_e($key, 'wpum'); ?>"
                      ...
                      data-name="<?php esc_attr_e($key, 'wpum'); ?>">
                <label style="display: none"
                       for="<?php esc_attr_e($key, 'wpum'); ?>"><?php echo $field['label']; ?><?php if (!empty($field['required'])) echo '<span class="wpum-required-star">*</span>'; ?></label>
        ...
        <p>
            ...
            <input type="submit" id="submit_wpum_register" name="submit_wpum_register" class="btn btn-default"
                   value="<?php _e('Register', 'wpum'); ?>"/>
        </p>
