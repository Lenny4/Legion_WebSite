...
class item_home_membership extends item_home
{
    function displayHome()
    {
        ...
        $return .= '<p class="message hidden-xs" style="top:50%;width: 50%;background-image: url(\'' . wp_get_attachment_image_src(132, "full")[0] . '\') ">
                    <span>' . $this->name . '</span>
                    </p>
